...
const NewsLetterPlusHowCards: React.FC = () => {
    return (
        <div className="combined-container bg-gray-50 text-center py-10">
            {/* Section 1: Learn how we work */}
            <div className="work-section mb-10">
                <h2 className="text-2xl font-semibold text-gray-800">
                    Learn how <span className="text-orange-500">we work</span>
                </h2>
                <div className="cards-container flex justify-center gap-6 mt-6">
                    {[
                        ...
                        >
                            <div className="overlay bg-black bg-opacity-50 h-full w-full flex items-center justify-center transition duration-300 hover:bg-opacity-75">
            ...
            <div className="mailing-list-section">
                ...
                <div className="input-container flex justify-center items-center gap-2">
                    <input
                        ...
                        className="px-4 py-2 w-80 rounded-l-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500"
                    />
